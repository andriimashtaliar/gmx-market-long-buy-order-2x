...
export function getV1Tokens(chainId) {
  return V1_TOKENS[chainId];
}

export function getV2Tokens(chainId) {
  return V2_TOKENS[chainId];
}

export function getTokensMap(chainId) {
  return TOKENS_MAP[chainId];
}

export function getWhitelistedV1Tokens(chainId) {
  return getV1Tokens(chainId);
}

export function getVisibleV1Tokens(chainId) {
...
export function convertTokenAddress(chainId, address, convertTo) {
...
export function isChartAvailabeForToken(chainId, tokenSymbol) {
  let token;
