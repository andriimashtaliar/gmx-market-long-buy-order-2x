...
export function maxOpenInterestKey(market, isLong) {
...
export function minPositionImpactPoolAmountKey(market) {
  return hashData(["bytes32", "address"], [MIN_POSITION_IMPACT_POOL_AMOUNT_KEY, market]);
}

export function positionImpactPoolDistributionRateKey(market) {
...
export function uiFeeFactorKey(address) {
...
export function maxAllowedSubaccountActionCountKey(account, subaccount, actionType) {
  return hashData(
...
export function subaccountActionCountKey(account, subaccount, actionType) {
  return hashData(
    ["bytes32", "address", "address", "bytes32"],
...
export function subaccountAutoTopUpAmountKey(account, subaccount) {
